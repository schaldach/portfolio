...
function Projects() {
    ...
    <div className="pagesection">
        ...
        <div className="showprojects">
            ...
            <Project title='Escala do Universo' description='Um site para a visualização da escala do universo, comparando lado a lado corpos de tamanhos próximos, começando com o planeta Terra até o Universo Observável.' tech='JavaScript | Next.js | React.js | CSS' github='https://github.com/schaldach/universescale' url='https://universescale.vercel.app/' 
