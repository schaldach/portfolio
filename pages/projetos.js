...
function Projetos() {
    ...
    <div className="pagesection projectsection">
        <div class="custom-shape-divider-top-1662411529">
        ...
        <div className="showprojects">
            <div>
                ...
                <div className="showdescription">O Nolt foi um site criado para organizar diversos tipos de anotações, entre eles notas, listas, links e imagens. Ele possui uma database na Supabase, e qualquer um pode criar seu usuário e começar a usá-lo para organizar as diversas coisas do dia-a-dia, de diversas maneiras diferentes.</div>
                <div className="techused">
                    <Image src={HtmlLogo} width='35' height='35' layout='fixed'/>
                    <Image src={CssLogo} width='35' height='35' layout='fixed'/>
                    <Image src={JsLogo} width='35' height='35' layout='fixed'/>
                    <Image src={ReactLogo} width='38' height='35' layout='fixed'/>
                    <Image src={NextLogo} width='70' height='35' layout='fixed'/>
                    <Image src={SupabaseLogo} width='35' height='35' layout='fixed'/>
                </div>
            </div>
            <div>
                ...
                <div className="techused">
                    ...
                    <Image src={CssLogo} width='35' height='35' layout='fixed'/>
                    <Image src={JsLogo} width='35' height='35' layout='fixed'/>
                    <Image src={P5Logo} width='35' height='35' layout='fixed'/>
                </div>
            </div>
        </div>
    </div>
